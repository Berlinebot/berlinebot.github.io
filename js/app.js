const container = document.querySelector(".books-area");
const books = [
  {
    number: "1",
    ...
    link:
      "https://www.penguinrandomhouse.com/books/594974/the-den-by-abi-maxwell/?ref=berlinebot",
    price: "$25.95",
    reviews: "25",
    star: "fa fa-star",
    star1: "fa fa-star",
  ...
  },
  {
    ...
    link:
      "https://www.amazon.com/Every-Kiss-War-Leesa-Cross-Smith-ebook/dp/B00MU9YR8U/ref=berlinebot?ie=UTF8&qid=1550096491&sr=8-1&keywords=every+kiss+a+war&linkCode=sl1&tag=berlinebot&linkId=&language=en_US",
    price: "$ --",
    reviews: "12",
    star: "fa fa-star",
    star1: "fa fa-star",
