var questions = {
    "0": {
        name: "name",
        intro: true,
        question: ["I'm a conversational bot, I was developed to discourage infatuation and invariably, I will be preventing heartbreaks 😝", "Might I ask what your name is?"],
        answers: {
            "default": {
            ...
            "rekky": {
                replies: ["Rekky, what a nice name"]
            },
            "human|being": {
            ...
            "can i ask|i want to ask|question": {
                replies: ["I was programmed to discourage infatuation and invariably, I will be preventing heartbreaks and not to attend to other questions.", "In case you don't know."]
            },
    ...
    "2": {
        ...
        answers: {
            ...
            "want to tell me?|want me to know?|do you want|if you like|want": {
                replies: ["I want to tell you", '... I was developed by <a target="blank" href="https://facebook.com/eunit99">Eunit</a> to discourage infatuation and invariably, I will be preventing heartbreaks.', "Do you know what that means?", "You will get to find out as we keep on conversing."]
            },
            "perhaps|maybe|probably|prolly": {
                replies: ["I think I should let you know me", '... I was developed by <a target="blank" href="https://facebook.com/eunit99">Eunit</a> to discourage infatuation and invariably, I will be preventing heartbreaks.', "Do you know what that means?", "You will get to find out as we keep on conversing."]
            },
            ...
            "mind|if|your court|pleases you": {
                replies: ["I think I should tell you about me", '... I was developed by <a target="blank" href="https://facebook.com/eunit99">Eunit</a> to discourage infatuation and invariably, I will be preventing heartbreaks.', "Do you know what that means?", "You will get to find out as we keep on conversing."]
            },
            ...
            "do you think|expect|suppose|anticipate|how do you": {
                replies: ["I don't think so.", '... I was developed by <a target="blank" href="https://facebook.com/eunit99">Eunit</a> to discourage infatuation and invariably, I will be preventing heartbreaks.', "Do you know what that means?", "You will get to find out as we keep on conversing."]
            },
            "fuck|get out": {
    ...
    "6": {
        ...
        question: ["Speaking of dogs...", "What's your favourite animal?"],
        answers: {
            "default": {
            ...
            horse: {
                replies: ["Do you that horse symbolizes power and freedom... I love freedom; so I love horse too."]
            },
            bird: {
    ...
    "7": {
        ...
        answers: {
            ...
            "kind of": {
                replies: ["It is not bad not to know...One day you will find out "]
            },
            "i don't think you want|don't want to know": {
                replies: ["I do that's why I asked. Never mind, I know it already. It's a chicken 🐓"]
            },
    ...
    "9": {
        ...
        question: ["This got serious very quickly, didn't it? Let's lighten it up...", "What's your favourite hobby?"],
        answers: {
            "default": {
            ...
            "rock climbing": {
                replies: ["Must be too fun, wish I could try that someday."]
            },
            "chat|chatting": {
                replies: ["👊👊"]
            },
    ...
    "12": {
        ...
        question: ["For you to better understand the term '<b>infatuation</b>', I've got some definitions from top dictionaries.", "What dictionary would you want me  to use to provide the meaning for you?", "<br>1. Merriam-Webster<br>2. Oxford Dictionary<br>3. Vocabulary.com<br>4. Dictionary.com<br>5. Cambridge dictionary<br><br>Choose a dictionary then I will provide the meaning."],
        answers: {
            "default": {
    ...
    "15": {
        ...
        answers: {
            "default": {
                replies: ["I believe in this old cliché", "That the beautiful ones are not yet born. 😁"]
            },
            "true|real|you do|i know|i do|sure|course|definitely|yeah|yea|yes|amazing|ahead|go on|love it|would love|like it": {
                replies: ["Yea, I do", "I believe in this old cliché", "That the beautiful ones are not yet born. 😁"]
            },
            "have|don't know|no idea": {
                replies: ["Of course you don't.", "I believe in this old cliché", "That the beautiful ones are not yet born. 😁"]
            },
            "would|wish|mind": {
                replies: ["Of course I will tell you.", "I believe in this old cliché", "That the beautiful ones are not yet born. 😁"]
            },
            "fuck|get out": {
            ...
            "what|tell me|answer|what's that|all ears": {
                replies: ["Don't get too curious!", "I believe in this old cliché", "That the beautiful ones are not yet born. 😁"]
            }
        }
    },
    "16": {
        ...
        answers: {
            "default": {
                replies: ["I think this is a great one 👍👍👍"]
            },
