...
function ConvState(wrapper, SingleConvState, form, params) {
    this.form = form, this.wrapper = wrapper, this.current = SingleConvState, this.answers = {}, this.parameters = params, this.scrollDown = function () {
...
SingleConvState.prototype.hasNext = function () {
        ...
        if (this.wrapper.find("div.options div.option").remove(), multiple) {
        ...
        $(this.wrapper).find("#messages").css({
            paddingBottom: diff
        }), $(this.wrapper).find(this.parameters.inputIdHashTagName).focus(), answerObject.hasOwnProperty("callback") && window[answerObject.callback](this), setTimeout(function () {
    ...
    function ($) {
        $.fn.convform = function (options) {
            ...
            var parameters = $.extend(!0, {}, {
                    ...
                    loadSpinnerVisible: "",
                    buttonText: "<img alt='Send' class='' src='img/paperplane.svg'>"
                }, options),
            ...
            if (inputs.length) {
                ...
                var singleState = new SingleConvState(inputs[0]),
                    state = new ConvState(this, singleState, form, parameters);
...
>>>>>>> 0dd1c24aa71e142c98ade8386f78a4bf34f8d981
    }(jQuery);