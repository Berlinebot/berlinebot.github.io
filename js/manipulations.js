$(window).on("load", function showPage() {
    $("body").ready(function () {
        $("header,section,footer").hide().delay(1000).fadeIn(2000).removeClass('startHide');
        // delay before fadeIn of the contents of header, section, and footer then .removeClass('startHide')
        $("#loader").show().delay(1000).fadeOut(1000);
...
(function ($) {
    $(document).ready(function () {
        ...
        $("#instantChat,#instantChat0,#instantChat1,#instantChat2,#instantChat3,#instantChat4").on("click", function () {
