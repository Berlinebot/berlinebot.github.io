...
$(window).on("load", function showPage() {
    $("body").ready(function () {
        $("header,section,footer").hide().delay(1000).fadeIn(2000).removeClass('startHide'); // delay before fadeIn of the contents after .removeClass('startHide')
        $("#loader").show().delay(1000).fadeOut(1000); // delay before fadeOut of the loader    
    });
});
...
$(window).on("load", function () {
    $("body").ready(function () {
        ...
        $(".chatbox_container__home").hide().delay(2000).fadeIn(1e3); // delay (2s) before fadeIn (100ms) of the chat window
        // Chatbox window for home START
        ...
        // Feedback form START
        $(".chatbox_container__feedback").hide().delay(90000).fadeIn(1e3); // delay (90s) before fadeIn (100ms) of the feedback window
...
(function ($) {
    $(document).ready(function () {
        ...
        $("#instantChat0,#instantChat1,#instantChat2,#instantChat3,#instantChat4").on("click", function () {
